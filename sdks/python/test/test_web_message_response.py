...
class TestWebMessageResponse(unittest.TestCase):
    """WebMessageResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebMessageResponse:
        """Test WebMessageResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebMessageResponse`
        """
    ...
    def testWebMessageResponse(self):
        """Test WebMessageResponse"""
