...
class TestWebYearMonthEntry(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> WebYearMonthEntry:
        """Test WebYearMonthEntry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebYearMonthEntry`
        """
        model = WebYearMonthEntry()
        if include_optional:
            return WebYearMonthEntry(
                balance = 1.337,
                expense = 1.337,
                income = 1.337,
                month = 56
    ...
    def testWebYearMonthEntry(self):
        """Test WebYearMonthEntry"""
