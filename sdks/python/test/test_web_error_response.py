...
class TestWebErrorResponse(unittest.TestCase):
    """WebErrorResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WebErrorResponse:
        """Test WebErrorResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WebErrorResponse`
        """
        model = WebErrorResponse()
        if include_optional:
