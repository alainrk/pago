...
class WebTrendResponse(BaseModel):
    """
    WebTrendResponse
    """ # noqa: E501
    var_from: Optional[StrictStr] = Field(default=None, alias="from")
    points: Optional[List[WebMonthPoint]] = None
    to: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["from", "points", "to"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "from": obj.get("from"),
            "points": [WebMonthPoint.from_dict(_item) for _item in obj["points"]] if obj.get("points") is not None else None,
            "to": obj.get("to")
        })
        return _obj
