...
class WebYearMonthEntry(BaseModel):
    """
    WebYearMonthEntry
    """ # noqa: E501
    balance: Optional[Union[StrictFloat, StrictInt]] = None
    expense: Optional[Union[StrictFloat, StrictInt]] = None
    income: Optional[Union[StrictFloat, StrictInt]] = None
    month: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["balance", "expense", "income", "month"]
