...
class WebSearchTransactionsResponse(BaseModel):
    """
    ...
    transactions: Optional[List[WebTransactionDTO]] = None
    __properties: ClassVar[List[str]] = ["limit", "offset", "total", "transactions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "total": obj.get("total"),
            "transactions": [WebTransactionDTO.from_dict(_item) for _item in obj["transactions"]] if obj.get("transactions") is not None else None
        })
        return _obj
