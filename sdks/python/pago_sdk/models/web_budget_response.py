...
class WebBudgetResponse(BaseModel):
    """
    WebBudgetResponse
    """ # noqa: E501
    ...
    pct: Optional[StrictInt] = None
    spent: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["amount", "currency", "hasBudget", "month", "pct", "spent"]
